...
namespace CRUDTests
{
    public class PeopleServiceTest
 {
  ...
  private readonly Mock<IPeopleRepository> _personRepositoryMock;
  ...
  public PeopleServiceTest(ITestOutputHelper testOutputHelper)
  {
   ...
   _personRepositoryMock = new Mock<IPeopleRepository>();
   _peopleRepository = _personRepositoryMock.Object;

   var diagnosticContextMock = new Mock<IDiagnosticContext>();
   var loggerMock = new Mock<ILogger<PersonGetterService>>();

   _peopleGetterService = new PersonGetterService(_peopleRepository, loggerMock.Object, diagnosticContextMock.Object);

   _peopleAdderService = new PersonAddService(_peopleRepository, loggerMock.Object, diagnosticContextMock.Object);

   _peopleDeleterService = new PersonDeleteService(_peopleRepository, loggerMock.Object, diagnosticContextMock.Object);

   _peopleSorterService = new PersonSortService(_peopleRepository, loggerMock.Object, diagnosticContextMock.Object);

   _peopleUpdaterService = new PersonUpdateService(_peopleRepository, loggerMock.Object, diagnosticContextMock.Object);
  ...
  public async Task AddPerson_PersonNameIsNull_ToBeArgumentException()
  {
   ...
   //When PeopleRepository.AddPerson is called, it has to return the same "person" object
  ...
  //When we supply proper person details, it should insert the person into the people list; and it should return an object of PersonResponse, which includes with the newly generated person id
  [Fact]
  public async Task AddPerson_FullPersonDetails_ToBeSuccessful()
  {
   ...
   //Act
   PersonResponse person_response_from_add = await _peopleAdderService.AddPerson(personAddRequest);
  ...
  public async Task GetPersonByPersonID_NullPersonID_ToBeNull()
  {
   ...
   //Act
   PersonResponse? person_response_from_get = await _peopleGetterService.GetPersonByPersonID(personID);
  ...
  public async Task GetPersonByPersonID_WithPersonID_ToBeSuccessful()
  {
   ...
   //Act
   PersonResponse? person_response_from_get = await _peopleGetterService.GetPersonByPersonID(person.PersonID);
  ...
  public async Task GetAllPersons_ToBeEmptyList()
  {
   ...
   //Act
   List<PersonResponse> persons_from_get = await _peopleGetterService.GetAllPeople();
  ...
  public async Task GetAllPersons_WithFewPersons_ToBeSuccessful()
  {
   ...
   _personRepositoryMock.Setup(temp => temp.GetAllPeople()).ReturnsAsync(persons);

   //Act
   List<PersonResponse> persons_list_from_get = await _peopleGetterService.GetAllPeople();
  ...
  public async Task GetFilteredPersons_EmptySearchText_ToBeSuccessful()
  {
   ...
   //Act
   List<PersonResponse> persons_list_from_search = await _peopleGetterService.GetFilteredPeople(nameof(Person.PersonName), "");
  ...
  public async Task GetFilteredPersons_SearchByPersonName_ToBeSuccessful()
  {
   ...
   //Act
   List<PersonResponse> persons_list_from_search = await _peopleGetterService.GetFilteredPeople(nameof(Person.PersonName), "sa");
  ...
  public async Task GetSortedPersons_ToBeSuccessful()
  {
   ...
   List<PersonResponse> allPersons = await _peopleGetterService.GetAllPeople();

   //Act
   List<PersonResponse> persons_list_from_sort = await _peopleSorterService.GetSortedPeople(allPersons, nameof(Person.PersonName), SortOrderEnum.Descending);
  ...
  public async Task UpdatePerson_NullPerson_ToBeArgumentNullException()
  {
   ...
   Func<Task> action = async () =>
   {
    await _peopleUpdaterService.UpdatePerson(person_update_request);
   };
  ...
  public async Task UpdatePerson_PersonFullDetails_ToBeSuccessful()
  {
   ...
   //Act
   PersonResponse person_response_from_update = await _peopleUpdaterService.UpdatePerson(person_update_request);
